...
echo -e "\n${GREEN}=== Pithos: Scale Stress-Test Completed Successfully ===${NC}"
echo -e "Note: Running inside Docker virtualization has CPU-sharing limits on macOS."
echo -e "To get absolute bare-metal performance, run Pithos natively on a Linux host:"
