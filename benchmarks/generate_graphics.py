...
def load_baselines():
    ...
    baselines_path = "temp/benchmark_data/baselines_metrics.json"
...
def update_readme():
    """Replace the BENCHMARK_METRICS block in README.md with live charts."""
    readme_path = "README.md"
    if not os.path.exists(readme_path):
        print("README.md not found, skipping update.")
        return

    # Build the performance section containing only visual charts
    lines = []
    ...
    with open(readme_path, "w") as f:
        f.write(content)
    print("README.md updated with live benchmark charts (stats removed).")
